...
-- Measured on GHC 9.14.1 / -O2 after LUT/EngineFinish port (2026-08-27):
-- raw/opt from @exe:jshark-life-metrics@ (rawNodes=548805, optNodes=567433).
maxLifeRawNodes :: Int
maxLifeRawNodes = 560000

maxLifeOptNodes :: Int
maxLifeOptNodes = 580000
