...
collectHvm2Kernels :: Expr Stamp u -> [Hvm2KernelEntry]
...
collectStdHvm2 :: Std Stamp u -> [Hvm2KernelEntry]
collectStdHvm2 = \case
  Fixed _ args -> collectFixedArgsHvm2 args
  Method m -> collectMethodHvm2 m
  Kernel k -> collectKernelHvm2 k

collectFixedArgsHvm2 :: FixedArgs Stamp a b c -> [Hvm2KernelEntry]
...
collectMethodHvm2 :: Method Stamp u -> [Hvm2KernelEntry]
...
collectKernelHvm2 :: Kernel Stamp u -> [Hvm2KernelEntry]
...
collectFieldLitHvm2 :: FieldLit Stamp r -> [Hvm2KernelEntry]
